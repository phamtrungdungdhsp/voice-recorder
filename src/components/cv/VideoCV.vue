  ...
  <div :class="$style.container" :style="`color: ${themeColor}`">
    ...
    <section :class="$style.experienceSection">
      <div :class="$style.left">
        <h3 :class="$style.title">
          <span :class="$style.star"><star-svg :fillColor="themeColor" /></span
          >Experience
        </h3>
      ...
      <div :class="$style.right">
        <div class="title">
          <p :class="$style.title" :style="`color: ${themeColor};`">
            Experience Video
          </p>
    ...
    <section :class="$style.language">
      ...
      <div :class="$style.item" v-for="(lang, index) in languages" :key="index">
        ...
        />
        <rate :value="lang.rate" :color="themeColor" />
      </div>
