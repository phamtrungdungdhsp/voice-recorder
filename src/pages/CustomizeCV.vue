      ...
      <div :class="$style.container">
        ...
        <section :class="$style.section2">
          <ul :class="$style.tabs">
            ...
            >
              ...
              <div :class="[$style.content, $style.listTheme]">
                <div
                  ...
                  :key="index"
                >
                  <p :class="$style.title" @click="chooseTheme(theme.value)">{{ theme.name }}</p>
            ...
            >
              ...
              <div :class="[$style.content, $style.fontColor]">
                <font-color @setThemeColor="setThemeColor"/>
              </div>
            </li>
            <!-- tab: add section -->
            <li
          ...
          <div :class="$style.list">
            <TextCV v-if="currentCV === cv.textCV" :themeColor="themeColor" />
            <VideoCV v-if="currentCV === cv.videoCV" :themeColor="themeColor" />
            <SoundCV v-if="currentCV === cv.soundCV" :themeColor="themeColor"/>
            <MixedMediaCV v-if="currentCV === cv.mixedCV" :themeColor="themeColor" />
          </div>
        </section>
      </div>
    </div>
...
import CvProvider from "../store/cv";
...
export default defineComponent({
  ...
  setup() {
    ...
    const currentCV: Ref<string> = ref(cv.value.textCV);
    ...
    const themes = ref([
      { name: "Text CV", value: cv.value.textCV },
      { name: "Video CV", value: cv.value.videoCV },
      { name: "Voice CV", value: cv.value.soundCV },
      { name: "Mixed Media CV", value: cv.value.mixedCV },
    ]);
    const chooseTheme = (theme: string) => {
      currentCV.value = theme;
    }
    return { themes, chooseTheme, tab, setTab, listSection, cv, currentCV, themeColor, setThemeColor };
  },
});
</script>
